<div class='w-full md:w-1/3 px-3 lg:p-6 flex flex-col flex-grow flex-shrink transform hover:scale-105 transition duration-500 ease-in-out hover:text-primary'>
  <div class='flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg'>
    <a href="{!! $home_item['permalink'] !!}" title="" class='flex flex-wrap no-underline hover:no-underline border-none'>
      ...
      <span class='w-full text-xs md:text-sm px-6 uppercase mb-2'><i class="fas fa-clock"></i> {!! $home_item['date'] !!}</span>
