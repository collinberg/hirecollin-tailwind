<header class="banner fixed lg:absolute w-full top-0 lg:bg-transparent">
  <div class="w-full container mx-auto flex flex-row items-center justify-between mt-0 py-2">
    ...
    <button id='searchToggle' class="desktop-search-toggle lg:border-l-2 border-primary lg:pl-2" data-search-toggle="closed" aria-label="Search Button">
    ...
    <button id='menuToggle' class='lg:hidden relative' data-menu-state="closed" aria-label="Menu Toggle">
